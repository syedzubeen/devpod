...
A new window appears showing DevPod starting the workspace. After the workspace is created, JetBrains Gateway should automatically open with a prefilled form for the workspace.
