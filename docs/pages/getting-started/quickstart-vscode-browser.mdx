...
A new window appears showing DevPod starting the workspace. After the workspace is created, VS Code should open automatically connected to the DevContainer.
